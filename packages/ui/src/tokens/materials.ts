...
export type MaterialName = 'ultra-thin' | 'thin' | 'regular' | 'thick' | 'glass' | 'glass-clear'
...
const lightTint = (alpha: number): MaterialTint => ({ rgb: [255, 255, 255], alpha })
const darkTint = (alpha: number): MaterialTint => ({ rgb: [37, 37, 37], alpha })

export const materials: Readonly<Record<MaterialName, Material>> = {
  'ultra-thin': { light: lightTint(0.55), dark: darkTint(0.3), blur: 10, saturate: 1.8 },
  thin: { light: lightTint(0.7), dark: darkTint(0.45), blur: 20, saturate: 1.8 },
  regular: { light: lightTint(0.82), dark: darkTint(0.62), blur: 30, saturate: 1.8 },
  thick: { light: lightTint(0.93), dark: darkTint(0.8), blur: 40, saturate: 1.8 },
  glass: { light: lightTint(0.5), dark: { rgb: [40, 40, 40], alpha: 0.5 }, blur: 16, saturate: 1.6 },
  'glass-clear': { light: lightTint(0.2), dark: { rgb: [0, 0, 0], alpha: 0.3 }, blur: 8, saturate: 1.4 },
}
