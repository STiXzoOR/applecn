...
export const fontFamilies = {
  ...
  rounded: 'ui-rounded, -apple-system, BlinkMacSystemFont, system-ui, sans-serif',
...
const iosWeights: Readonly<Record<TextStyleName, readonly [FontWeight, FontWeight]>> = {
  'large-title': [400, 700],
  'title-1': [400, 700],
  'title-2': [400, 700],
  'title-3': [400, 600],
...
export const dynamicType: Readonly<Record<DynamicTypeCategory, readonly TextStyle[]>> = {
...
const mac = (name: TextStyleName, size: number, leading: number, weight: FontWeight, emphasized: FontWeight): TextStyle => ({
  name,
  size,
  leading,
  weight,
 ...
 */
export const tracking: readonly { readonly size: number; readonly tracking: number }[] = [
  { size: 11, tracking: 6 },
  { size: 12, tracking: 0 },
  { size: 13, tracking: -6 },
  { size: 14, tracking: -11 },
