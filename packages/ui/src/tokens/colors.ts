...
export type GrayName = 'gray' | 'gray-2' | 'gray-3' | 'gray-4' | 'gray-5' | 'gray-6'
...
export const systemColors: readonly SystemColor[] = [
  ...
  system('orange', [255, 141, 40], [255, 146, 48], [197, 83, 0], [255, 160, 86]),
  ...
  system('indigo', [97, 85, 245], [109, 124, 255], [86, 74, 222], [167, 170, 255]),
  system('purple', [203, 48, 224], [219, 52, 242], [176, 47, 194], [234, 141, 255]),
  system('pink', [255, 45, 85], [255, 55, 95], [231, 18, 77], [255, 138, 196]),
  system('brown', [172, 127, 94], [183, 138, 102], [149, 109, 81], [219, 166, 121]),
]

const gray = (name: GrayName, light: Rgb, dark: Rgb, lightAccessible: Rgb, darkAccessible: Rgb): Gray => ({
  name,
  light: { rgb: light },
  dark: { rgb: dark },
  lightAccessible: { rgb: lightAccessible },
...
export const grays: readonly Gray[] = [
  gray('gray', [142, 142, 147], [142, 142, 147], [108, 108, 112], [174, 174, 178]),
  gray('gray-2', [174, 174, 178], [99, 99, 102], [142, 142, 147], [124, 124, 128]),
...
export type LabelName = 'label' | 'label-2' | 'label-3' | 'label-4' | 'placeholder'
...
export const backgrounds: Readonly<Record<BackgroundName, Background>> = {
  background: { light: c(255, 255, 255), dark: c(0, 0, 0), darkElevated: c(28, 28, 30) },
  'background-2': { light: c(242, 242, 247), dark: c(28, 28, 30), darkElevated: c(44, 44, 46) },
  'background-3': { light: c(255, 255, 255), dark: c(44, 44, 46), darkElevated: c(58, 58, 60) },
}

export type GroupedBackgroundName = 'grouped-background' | 'grouped-background-2' | 'grouped-background-3'

export const groupedBackgrounds: Readonly<Record<GroupedBackgroundName, Background>> = {
  'grouped-background': { light: c(242, 242, 247), dark: c(0, 0, 0), darkElevated: c(28, 28, 30) },
  'grouped-background-2': { light: c(255, 255, 255), dark: c(28, 28, 30), darkElevated: c(44, 44, 46) },
  'grouped-background-3': { light: c(242, 242, 247), dark: c(44, 44, 46), darkElevated: c(58, 58, 60) },
}
