...
describe("Input", () => {
  test("is the bordered text field by default: the platform's height and corner, a hairline, on the tertiary background", () => {
    ...
    expect(i.className).toContain("border-(length:--input-border-width)")
    expect(i.className).toContain("border-(--input-border-color)")
    expect(i.className).toContain("bg-background-3")
    expect(i.className).toContain("shadow-(--input-shadow)")
...
describe("Textarea", () => {
  test("is a multi-line text view on the same surface", () => {
    ...
    expect(t.className).toContain("border-(length:--textarea-border-width)")
    expect(t.className).toContain("border-(--textarea-border-color)")
    expect(t.className).toContain("shadow-(--textarea-shadow)")
