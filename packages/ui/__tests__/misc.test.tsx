...
import { Avatar, AvatarFallback, AvatarImage, avatarVariants } from '../src/components/avatar'
...
describe('Avatar', () => {
  test('shows the monogram until an image loads', () => {
    ...
    expect(fallback.closest('[data-slot="avatar"]')!.className).toContain('rounded-full')
