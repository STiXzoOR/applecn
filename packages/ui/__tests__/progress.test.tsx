...
describe('Progress', () => {
  ...
  test('an indeterminate bar has no value and animates', () => {
    ...
    expect(bar.querySelector('[data-slot="progress-indicator"]')!.className).toContain('animate-')
  })
  ...
  test('the circular variant draws a ring whose dash offset follows the value', () => {
    ...
    const arc = ring.querySelector('[data-slot="progress-circular-indicator"]') as SVGCircleElement
