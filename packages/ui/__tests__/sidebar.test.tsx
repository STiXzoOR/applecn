...
import { Sidebar, SidebarGroup, SidebarHeader, SidebarItem } from '../src/components/sidebar'
...
describe('Sidebar', () => {
  test('is a navigation of labelled groups on the regular material with the current item filled', () => {
    ...
    expect(starred.querySelector('[data-slot="sidebar-item-icon"]')!.getAttribute('class')).toContain('text-primary')
  })
