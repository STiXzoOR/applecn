...
import { DisclosureGroup, DisclosureGroupPanel, DisclosureGroupTrigger } from '../src/components/disclosure-group'
...
describe('DisclosureGroup', () => {
  test('hides its details until the row is pressed, turning the chevron', async () => {
    ...
    const chevron = trigger.querySelector('[data-slot="disclosure-group-chevron"]')!
    expect(chevron.getAttribute('class')).toContain('group-data-open/disclosure:rotate-90')
