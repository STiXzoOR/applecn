...
describe("Text", () => {
  ...
  test("emphasized applies the variant-specific emphasized weight", () => {
    expect(textVariants({ variant: "body", emphasized: true })).toContain(
      "font-(--type-body-emphasized)"
    )
    expect(textVariants({ variant: "headline", emphasized: true })).toContain(
      "font-(--type-headline-emphasized)"
    )
