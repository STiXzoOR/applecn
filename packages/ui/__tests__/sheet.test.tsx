...
import { Sheet, SheetClose, SheetContent, SheetTitle, SheetToolbar, SheetTrigger } from '../src/components/sheet'
  ...
  return (
    <Sheet>
      ...
      <SheetContent detent={props.detent}>
        <SheetToolbar cancel={<SheetClose>Cancel</SheetClose>} done={<button type="button">Add</button>}>
