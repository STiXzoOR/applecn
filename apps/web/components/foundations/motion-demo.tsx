...
export function MotionDemo({
  ...
  return (
    <button
      type="button"
      className="grid grid-cols-[10rem_1fr] items-center gap-4 rounded-3xl bg-card px-4 py-3 text-start outline-none focus-visible:ring-4 focus-visible:ring-ring/60"
