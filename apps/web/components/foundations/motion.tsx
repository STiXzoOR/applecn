  ...
  return (
    <>
      ...
      <Section
        ...
        description="Hover or focus a row to play it."
      >
      ...
      <Section title="Values">
        <TokenTable
          columns={["Token", "Value"]}
          rows={[
            ...Object.entries(easings).map(([n, v]) => [`--easing-${n}`, v]),
            ...Object.entries(springs).map(([n, v]) => [
              `--spring-${n}`,
              <Text key={n} variant="caption-2" className="font-mono break-all">
                {v}
              </Text>,
            ]),
          ]}
