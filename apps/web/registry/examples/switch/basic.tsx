  ...
  return (
    <List aria-label="Connectivity">
      <ListSection>
        ...
        <ListRow
          title="Wi-Fi"
          trailing={<Switch aria-label="Wi-Fi" defaultChecked />}
        />
        <ListRow
          title="Low Power Mode"
          trailing={
            <Switch aria-label="Low Power Mode" color="tint" defaultChecked />
          }
        />
        <ListRow
          title="Unavailable"
          trailing={<Switch aria-label="Unavailable" disabled />}
        />
      </ListSection>
    </List>
  )
