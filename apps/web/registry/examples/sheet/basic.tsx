...
import { Sheet, SheetClose, SheetContent, SheetSection, SheetTitle, SheetToolbar, SheetTrigger } from '@apple-ds/ui/components/sheet'
...
export default function SheetBasic() {
  return (
    <Sheet>
      ...
      <SheetContent>
        <SheetToolbar cancel={<SheetClose>Cancel</SheetClose>} done={<SheetClose>Add</SheetClose>}>
        ...
        <List aria-label="Options" className="py-0">
          <ListSection>
            <ListRow title="All-day" trailing={<Switch aria-label="All-day" />} />
