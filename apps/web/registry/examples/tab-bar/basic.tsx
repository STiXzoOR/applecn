...
import { TabBar, TabBarItem, TabBarSearch } from '@apple-ds/ui/components/tab-bar'
  ...
  return (
    <div className="relative h-72 overflow-hidden rounded-4xl bg-[linear-gradient(160deg,var(--system-mint),var(--system-indigo))] p-4">
      <div className="flex items-center gap-2 text-white">
        <Switch aria-label="Minimized" checked={minimized} onCheckedChange={setMinimized} color="tint" />
        <Text color="inherit">Minimize on scroll</Text>
      </div>
      <TabBar aria-label="Main" value={value} onValueChange={setValue} minimized={minimized} className="absolute">
